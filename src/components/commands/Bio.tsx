    ...
    <div className="mt-2 mb-5 w-11/12 mx-auto font-mono text-sm">
      ...
      <div className="grid grid-cols-2">
        {links.map(({ Icon, text, href, title }, index) => {
          return (
            <div className="mt-2 mb-5 w-11/12 mx-auto font-mono text-sm  ">
              <div className="flex items-center gap-2 mt-3 space-x-3 " key={index}>
                <div className="text-sm font-mono flex items-center gap-1 text-white">
                  <Icon />
                  {/* <h1>{title}</h1> */}
                </div>
                <a
